...
import (
	...
	"github.com/gorilla/mux"                  // import midtrans-go package ...
	"github.com/midtrans/midtrans-go/coreapi" // import midtrans-go/coreapi package ...

	// import midtrans-go/snap package ...
...
func (h *handlerTransaction) FindAllTransaction(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")

	transaction, err := h.TransactionRepository.FindAllTransaction()
	if err != nil {
...
func (h *handlerTransaction) GetTransaction(w http.ResponseWriter, r *http.Request) {
	...
	w.WriteHeader(http.StatusOK)
	response := dto.SuccessResult{Code: http.StatusOK, Data: ResponseTransaction(transaction)}
	json.NewEncoder(w).Encode(response)
}
...
func (h *handlerTransaction) CreateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	// var request transactiondto.AddTransaction
	...
	// transaction, err = h.TransactionRepository.GetTransaction(IDTransaction.ID)
	// if err != nil {
	// 	w.WriteHeader(http.StatusInternalServerError)
	// 	response := dto.ErrorResult{Code: http.StatusInternalServerError, Message: err.Error()}
	// 	json.NewEncoder(w).Encode(response)
...
func (h *handlerTransaction) DeleteTransaction(w http.ResponseWriter, r *http.Request) {
	...
	w.WriteHeader(http.StatusOK)
	response := dto.SuccessResult{Code: http.StatusOK, Data: ResponseTransaction(data)}
	json.NewEncoder(w).Encode(response)
}
...
func SendMail(status string, transaction models.Transaction) {
	...
	if status != transaction.Status && (status == "success") {
		...
		var CONFIG_SENDER_NAME = os.Getenv("SYSTEM_EMAIL")
		var CONFIG_AUTH_EMAIL = os.Getenv("EMAIL_SYSTEM")
		var CONFIG_AUTH_PASSWORD = os.Getenv("PASSWORD_SYSTEM")

		var Name = transaction.User.Name
...
func ResponseTransaction(u models.Transaction) transactiondto.Transaction {
